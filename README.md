...
I'm tracking or using the following skills in my daily workflows.
...
Other skills from this batch that I would highlight:

- **[ask-matt](https://github.com/mattpocock/skills/blob/main/skills/engineering/ask-matt/SKILL.md)** &mdash; Ask which skill or flow fits your situation. A router over the user-invoked skills in this repo.
- **[setup-matt-pocock-skills](https://github.com/mattpocock/skills/blob/main/skills/engineering/setup-matt-pocock-skills/SKILL.md)** &mdash; Configure your repo for the engineering skills (issue tracker, triage labels, domain doc layout). Run once per repo before using the other engineering skills.
- **[handoff](https://github.com/mattpocock/skills/blob/main/skills/productivity/handoff/SKILL.md)** &mdash; Compact the current conversation into a handoff document so another agent can continue the work.
- **[writing-great-skills](https://github.com/mattpocock/skills/blob/main/skills/productivity/writing-great-skills/SKILL.md)** &mdash; Reference for writing and editing skills, including the vocabulary and principles that make a skill predictable.

### addyosmani/agent-skills

[addyosmani/agent-skills](https://github.com/addyosmani/agent-skills): Production-grade engineering skills for AI coding agents from [Addy Osmani](https://addyosmani.com/), an evangelist in the space who works at Google. I initially leveraged this set of skills in my engineering workflow, but I have since shifted to using Matt Pocock's skills.

### Visual Design

#### ui.sh

[ui.sh](https://ui.sh) is from the team at [Tailwind Labs](https://github.com/tailwindlabs). I use these skills to improve the UI of the products that I build.
